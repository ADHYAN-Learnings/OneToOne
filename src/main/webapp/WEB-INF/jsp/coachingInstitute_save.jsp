  ...
  <div>
    ...
    <div>
     <table>
      ...
      <tr><td><form:label path="coachingInstitute_Address.location">Location</form:label></td>
      <td>
      <form:input type="text" id="location" path="coachingInstitute_Address.location"/>
      <form:errors path="coachingInstitute_Address.location" cssClass="error"/>
      </td>
      </tr>
